...
# File: XXX_MS1_metabaR_diagnostic.html
	# A diagnostic file reporting on the XXX_MS1_obitab characteristics and
	# additional filtering (contaminents, tagsjumps, etc.). 
	# Chloroplastic and Mitochondrial sequences were removed after this step.
# File : XXXMS1.cleandata.rds
	...
	# More information about the content of each file can be found in the "README_Data_description_XXX_etal_MS1" file.
